...
### Let's make the API call and see if it runs succesfully. It sure does run successfully and will return an authentication prompt that you might want to choose yes for auto authentication. Now let us get tweets under our target @ handle and store them in a data frame(suitable data structure )
```{r}
tweets <- twitteR::searchTwitter("@iaboyeji",n =1000,lang ="en",since = '2018-12-01')
